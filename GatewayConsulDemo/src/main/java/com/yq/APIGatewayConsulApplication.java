...
public class APIGatewayConsulApplication  {
    private static final Logger logger = LoggerFactory.getLogger(APIGatewayConsulApplication.class);
    ...
    public static void main(String[] args) {
        SpringApplication.run(APIGatewayConsulApplication.class, args);
