 ...
 * under the License.
 */
package com.yq.official.cache;


import com.yq.official.framework.CreateClientExamples;
...
public class TreeCacheExample
{
    public static void main(String[] args) throws Exception
    {
        ...
        TreeCache cache = TreeCache.newBuilder(client, "/zktest").setCacheData(false).build();
