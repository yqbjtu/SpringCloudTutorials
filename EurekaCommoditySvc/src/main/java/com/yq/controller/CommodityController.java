...
public class CommodityController {
    ...
    @GetMapping(value = "/commodities/{userId}", produces = "application/json;charset=UTF-8")
    public Commodity getCommodity(@PathVariable String userId) {
        Commodity commodity = (Commodity) commodityMap.get(userId);
        return commodity;
    }
